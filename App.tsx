...
const App: React.FC = () => {
  ...
  const renderView = () => {
    ...
    switch (currentView) {
      ...
      case 'TRANSACTIONS':
        return <Transactions transactions={transactions} setTransactions={setTransactions} categories={categories} setCategories={setCategories} />;
      case 'INVESTMENTS':
        return <Investments investments={investments} setInvestments={setInvestments} setTransactions={setTransactions} />;
      case 'BILLS':
        return <Bills bills={bills} setBills={setBills} setTransactions={setTransactions} />;
      case 'FORECAST':
  ...
  return (
    <div className="flex h-screen bg-slate-50 overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto">
          ...
          <div className="flex items-center gap-4">
            <div className="text-right">
              ...
              <p className="font-bold text-slate-900">
                R$ {transactions
                  .filter(t => !t.description.includes('[INVESTIMENTO]'))
        ...
        <div className={`p-8 ${currentView === 'FORECAST' ? 'max-w-none' : 'max-w-7xl'} mx-auto`}>
          {aiAnalysis && (
